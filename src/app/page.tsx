...
//   • Hero — full-bleed liquid-metal video, headline, CTAs, four
//     regulatory trust chips, Eos / Dr Arup Sen credibility line.
//   • Why — three sourced stats with [1][2][3] markers.
//   • The Loop — Test / Interpret / Track three-step pattern.
//   • BAS + Six markers — score and the markers it derives from,
//     in a single merged section.
//   • Meo AI conversation mock — chat-style card showing plain-English
...
//     claim.
//   • FAQ — three questions.
//   • Closing CTA — single primary action with risk-reversal microcopy.
//   • Sources — linked to BHF + PubMed.
//   • Sticky mobile CTA — persistent buy-path on mobile scroll.
// ─────────────────────────────────────────────────────────────────────
