...
export const metadata: Metadata = {
  ...
  description:
    "Powering Prevention, Insight and Outcomes — Together. Whether you're a doctor, clinic, health coach, PT, gym, corporate well-being provider, insurer, wearable tech company, pharma team, or research organisation — Meterbolic helps you deliver preventative care earlier and generate real-world outcome data.",
};
      ...
      <section className="px-5 sm:px-6 py-12 sm:py-16" style={{ background: C.bgDeep }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 text-base sm:text-lg" style={{ color: C.muted }}>
            <p>
              Whether you&apos;re a doctor, clinic, health coach, PT, gym, corporate well-being provider, insurer, wearable tech company, pharma team, or research organisation — Meterbolic enables you to deliver preventative care earlier, generate real-world outcome data, and create new value for the people you support.
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-5 items-stretch">
            ...
            >
              ...
              <div className="space-y-4 text-sm sm:text-base leading-relaxed" style={{ color: C.muted }}>
                ...
                <p>
                  His practice sits naturally alongside Meterbolic: where Meo gives people daily
                  visibility of their metabolic signal at home, Eos provides the consultant-level
            ...
            >
              <Quote className="h-6 w-6 mb-4" style={{ color: C.primary }} aria-hidden />
              <p
                className="text-base sm:text-lg italic leading-relaxed"
                style={{ color: C.fg, fontFamily: FONT_SERIF }}
              >
                &ldquo;Longevity is not simply about living longer — it is about preserving vitality,
            ...
            {[
              {
                ...
                body: 'Triple accreditation in Geriatric, Stroke & General Internal Medicine.',
              },
              {
                icon: GraduationCap,
                title: 'MRCP · 15+ years',
                body: 'Member of the Royal College of Physicians, with 15+ years of clinical experience.',
              },
              {
                icon: Microscope,
                title: 'Certified Longevity Physician',
                body: 'Trained specifically in longevity medicine and functional health care.',
              },
              {
                icon: Award,
                title: 'BiteLabs HealthTech Fellow',
                body: 'Clinical experience at Cleveland Clinic London, Queen Square & University College Hospital.',
              },
            ].map((c) => {
              const Icon = c.icon;
              return (
                ...
                >
                  ...
                  <h4 className="font-bold text-sm mb-1.5" style={{ color: C.fg }}>{c.title}</h4>
