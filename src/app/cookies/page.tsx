...
export default function CookiesPage() {
  return (
    ...
    >
      ...
      <section>
        <LegalH2>2. How we use cookies</LegalH2>
        <p className="mb-3">We use cookies for the following purposes:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Essential cookies</strong> — necessary for the website to
            function correctly (e.g. maintaining your checkout session via
            Stripe).
          </li>
          <li>
            <strong>Performance cookies</strong> — help us understand how
            visitors use our site so we can improve it (aggregate, anonymised
            counts only).
          </li>
          <li>
            <strong>Functional cookies</strong> — remember your preferences to
            give you a better experience on return visits.
          </li>
          <li>
      ...
      <section>
        <LegalH2>3. Types of cookies we use</LegalH2>
        <ul className="list-disc pl-6 space-y-2">
          <li>
          ...
          <li>
            ...
            deleted or they expire. Used for de-duplicated visit counting by
          ...
          <li>
            <strong>Third-party cookies</strong> — set by our service providers
            (see below).
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Analytics provider</strong> — privacy-respecting aggregate
            page-view counting. No cross-site tracking, no personal profiles
            built.
          </li>
        </ul>
        <p className="mt-3">
          We do <strong>not</strong> use Google Analytics, Facebook Pixel, or
          any other advertising-network tracking cookies on this site.
        </p>
      </section>

      <section>
        <LegalH2>5. Managing cookies</LegalH2>
        <p className="mb-3">
        ...
        <p className="mt-3">
          Please note that disabling essential cookies will affect the checkout
      ...
      <section>
        ...
        <p>
          ...
          notify you of significant changes by posting the new policy here with
          a revised date.
        </p>
      </section>
