...
export const metadata: Metadata = {
  ...
  description:
    'How Metabolic Health Ltd collects, uses, and protects your personal information.',
  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          Metabolic Health Ltd (&ldquo;we&rdquo;, &ldquo;us&rdquo;) operates
          shop.meterbolic.com, the Meo Metabolic Health Cholesterol Tracker shop.
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Health &amp; metabolic data</strong> — lipid readings,
            metabolic test results, and health history you choose to log into the
            Meo AI service. This data is used solely to provide your personalised
            Meo AI experience and generate your reports. It is never sold or
            shared with third parties for marketing.
          </li>
          <li>
            <strong>Account &amp; newsletter data</strong> — email address (you
            submit it at checkout or via the subscribe form) so we can set up
            your Meo AI account and send product updates you have opted in to
            receive.
          </li>
          <li>
            <strong>Operational logs</strong> — IP address, user agent,
            timestamp of requests, retained for at most 90 days for security
            and troubleshooting.
          </li>
          <li>
      ...
      <section>
        <LegalH2>3. Why we collect it</LegalH2>
        <p>
          ...
          tax and consumer-protection law (e.g. retaining invoice records). We
          do <strong>not</strong> sell your data, and we do not share it with
          marketing partners.
        </p>
      </section>
      ...
      <section>
        <LegalH2>5. Your rights (UK GDPR)</LegalH2>
      ...
      <section>
        ...
        <p>
          We&rsquo;ll post any material updates here with a revised
